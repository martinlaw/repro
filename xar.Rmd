...
## The Terminology
 ...
 - **github**: a website/hosting service for your repo (like Dropbox but better);
 - **commit**: a version/snapshot of your repo that you create, along with a message that you write;
...
When you (or someone else) opens the project on another computer, renv can be used to download and install those packages (command `renv::restore()`).
...
# Part 2 and 3: Docker and Nikita
