...
```{r, echo=F}
barriers.only <- data.frame(Barrier=c("Multiple versions of code and/or data",
                                  "Code: problematic use of file paths",
                                  "Copying results from R to separate manuscript",
                                  "Unclear order of running scripts",
                                  "Unclear software dependencies",
...
# What version control looks like once it's set up
...
# How to set it version control (single project in R)
